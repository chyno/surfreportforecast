define('app',['exports'], function (exports) {
  ...
  var App = exports.App = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.map([{ route: ['', 'foo'], name: 'foo', moduleId: 'foo', nav: true, title: 'Foo' }, { route: ['welcome'], name: 'welcome', moduleId: 'welcome', nav: true, title: 'Reading' }, { route: ['manage'], name: 'manage', moduleId: 'manage', nav: true, title: 'Manage Locations' }]);
      this.router = router;
    };
...
define('text!foo.html', ['module'], function(module) { module.exports = "<template>\r\n<p>Hello world from foo</p>\r\n</template>\r\n"; });
